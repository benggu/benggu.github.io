document.querySelector("header").innerHTML=`<a href="/"><h1>microbenggu place</h1></a> <img src="/logo.png" style="height:100%"> -- <span id="tagline" style="font-style: italic;">"it sure is great here"</span>
            <form id="searchbar">
